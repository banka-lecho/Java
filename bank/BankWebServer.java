...
//            "  <td>{level}</td>" +
    ...
    private final Map<String, App> apps = Map.ofEntries(
            app("Client 1", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.Shpileva.bank.Client", "client-1"),
            app("Client 2", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.Shpileva.bank.Client", "client-2"),
            app("Client 3", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.Shpileva.Client", "client-3"),
            app("Server 1", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.Shpileva.bank.Server", "8881"),
            app("Server 2", "java", "-cp", CLASSPATH, "info.kgeorgiy.ja.Shpileva.bank.Server", "8882"),
    ...
    public static void main(final String[] args) throws IOException {
        new BankWebServer().start(args.length > 0 ? Integer.parseInt(args[0]) : 8819);
    }
